// // Ok now i want you also update the Frontend componet  and you want to write the compleate code line by line and word by word
// // with out missing a single feature

// // remove those coloum those we deleate from backend and add those coloums thoso we add in the backend

// // and also add the cusmot selection for 2) Custom (Jump Time *) , (Party Room Time *)  in BirthDay Packages
// // if your select the custom then a text box open and also a small cancel butotn. as we do in the hoursofoperation. 
// // now you have to write  the compleate code line by line and word by word
// // with out missing a single feature
